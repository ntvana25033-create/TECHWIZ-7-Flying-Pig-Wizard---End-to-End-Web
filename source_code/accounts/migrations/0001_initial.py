    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_name', models.CharField(choices=[('STUDENT', 'Sinh viên'), ('ADMIN', 'Quản trị viên')], max_length=30, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Chờ xác nhận'), ('ACTIVE', 'Hoạt động'), ('DISABLED', 'Vô hiệu hóa'), ('LOCKED', 'Tạm khóa')], default='ACTIVE', max_length=20)),
